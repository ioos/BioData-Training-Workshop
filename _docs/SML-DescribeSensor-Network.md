+++
draft = false
title = "IOOS SOS v1.0 SML DescribeSensor-Network Template"
description = ""
type = "post"
...
_Template for a generic (independent of feature type) SensorML DescribeSensor response for Network of Stations_
<!--more-->
